            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Image.asset(Res.ic_circle_avatar,width: 50,height: 50,),
                ),
                Expanded(
                  child: Padding(
                    child: Text(
                ...
                InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(Res.ic_check,width: 40,height: 40,),
                  ),
                ),
                InkWell(
                  onTap: (){
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(Res.ic_cross,width: 40,height: 40,),
                  ),
                ),
              ],
            ),
           ...
           Row(
             children: [
               Padding(
                   ...
                   child: Image.asset(Res.ic_time,width: 15,height: 15,)
               ),
               Padding(
                 child: Text(
                   result.picktime,
